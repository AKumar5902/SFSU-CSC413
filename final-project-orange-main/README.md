...
## Team Orange: Anuj Kumar, Kyle Munar, Hetgar Peralta
- We are team Oragne and we are making an online dicusion forum that includes features such as writing and keeping mesaages, contacts, and username.

- Kyle Munar: Backend and bridged front end for addContacts, as well as pre-final application implementation

- Anuj Kumar: Backend: MessageDto,MessageDao,MessageHandler FrontEnd: Send Message box creation and handleSend and handleCancel.

- Hetgar Peralta : Frontend, the contact list and the delete function. Video link of the project's demo: https://youtu.be/JRDwXVbc_i0
