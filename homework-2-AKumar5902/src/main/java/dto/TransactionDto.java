...
public class TransactionDto extends BaseDto {
    ...
    public static TransactionDto fromDocument(Document document) {
        ...
        trans.setUserId(document.getString("userId"));
        trans.setToId(document.getString("toId"));
        trans.setAmount(document.getDouble("amount"));
        trans.setTimestamp(document.getLong("timestamp"));
        trans.setTransactionType(TransactionType.valueOf(document.getString("transactionType")));
        return trans;
    }
}
